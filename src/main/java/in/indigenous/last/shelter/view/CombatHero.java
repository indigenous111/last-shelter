...
public class CombatHero {
	...
	private int minusEnemyTurns;

	private double lowerEnemyDamage;
	...
	public int getMinusEnemyTurns() {
		return minusEnemyTurns;
	}

	public void setMinusEnemyTurns(int minusEnemyTurns) {
		this.minusEnemyTurns = minusEnemyTurns;
	}

	public double getLowerEnemyDamage() {
		return lowerEnemyDamage;
	}

	public void setLowerEnemyDamage(double lowerEnemyDamage) {
		this.lowerEnemyDamage = lowerEnemyDamage;
	}
